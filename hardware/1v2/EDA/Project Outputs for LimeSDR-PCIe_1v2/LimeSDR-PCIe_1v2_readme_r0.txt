...
Drill files
-----------------
   - LimeSDR-PCIe_1v2.DRR -> Drill report detailing the tool assignments, hole sizes, hole count and tool travel. 
   
   - Throughole vias are covered in the following files:
   								File Name																	Start Layer						Stop Layer
						LimeSDR-PCIe_1v2-RoundHoles.TXT															Top									Bottom
   - Slotholes are covered in the following files:
						LimeSDR-PCIe_1v2-SlotHoles.TXT															Top									Bottom	
...
---------------
		...
		LimeSDR-PCIe_1v2.GTL				Top (RF/GND)
		LimeSDR-PCIe_1v2.G1				L2  (GND)
		LimeSDR-PCIe_1v2.G2				L3  (PWR/Siglan/GND)
		LimeSDR-PCIe_1v2.G3				L4  (Signal/PWR/GND)
		LimeSDR-PCIe_1v2.G4				L5  (Signal/PWR/GND)
		LimeSDR-PCIe_1v2.G5				L6  (PWR/GND)
		LimeSDR-PCIe_1v2.G6				L7  (PWR/GND)	
		LimeSDR-PCIe_1v2.G7				L8  (Signal/PWR/GND)
		LimeSDR-PCIe_1v2.G8				L9  (GND/PWR)
		LimeSDR-PCIe_1v2.G9				L10 (CLK/Signal)
		LimeSDR-PCIe_1v2.G10				L11 (GND)
		LimeSDR-PCIe_1v2.GBL				Bottom (Signal/PWR/GND)

		 
		LimeSDR-PCIe_1v2.GPB				Bottom Pad Master
		LimeSDR-PCIe_1v2.GPT				Top Pad Master

		LimeSDR-PCIe_1v2.GTO				Top Overlay
		LimeSDR-PCIe_1v2.GTP				Top Paste
		LimeSDR-PCIe_1v2.GTS				Top Solder

 
		LimeSDR-PCIe_1v2.GBS				Bottom Solder
		LimeSDR-PCIe_1v2.GBP				Bottom Paste
		LimeSDR-PCIe_1v2.GBO				Bottom Overlay


		LimeSDR-PCIe_1v2.GM1				Mechanical 1 (Board Cutout)


		LimeSDR-PCIe_1v2.GM14				ASM BOT (Assembly bottom)
		LimeSDR-PCIe_1v2.GM15				ASM TOP (Assembly top)
